...
@torch.no_grad()
def run(data=ROOT / 'data/coco128_2.yaml',  # 'dataset.yaml path'
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/coco128_2.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'qg/val12.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--iou-thres', type=float, default=0.05, help='TF.js NMS: IoU threshold .45')
    parser.add_argument('--conf-thres', type=float, default=0.25, help='TF.js NMS: confidence threshold .25')
